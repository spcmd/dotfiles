...
-- ADDED: For using globals.homepage at line 75
require "globals"
...
function add(uri, title, update_visits)
    ...
    -- Ignore blank uris
    -- ADDED: ignore globals.homepage and luakit internal pages (luakit://)
    if not uri or uri == "" or uri == "about:blank" or uri == globals.homepage or uri == string.match(uri, '^luakit.*$') then return end
