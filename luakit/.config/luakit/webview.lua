    ...
    populate_popup = function (view, w)
        view:add_signal("populate-popup", function (v)
            ...
            return {
                ...
                true,
                { "€ Convert EUR->HUF: "..highlighted, function () w:enter_cmd(":convert-EUR-HUF") w:activate() end },
                { "£ Convert GBP->HUF: "..highlighted, function () w:enter_cmd(":convert-GBP-HUF") w:activate() end },
                { "$ Convert USD->HUF: "..highlighted, function () w:enter_cmd(":convert-USD-HUF") w:activate() end },
                true,
